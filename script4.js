...
//và kết quả trả về của function này sẽ là gọi function nhận vào làm tham số với đối số là biến maximum trên.


//6. Gọi function waveAlpha2015FuelCalc để xem đổ đầy bình xe Wave Alpha 2015 sẽ hết bn xèng

//7. Tạo 1 function có nội dung chứa 3 biến được khai báo bằng let / const / var. thử truy cập 3 biến đó từ 1 function bên ngoài function trên.
